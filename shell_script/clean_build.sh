...
rm -rf ./@cli-dang/input/lib -rf ./@cli-dang/input/index.js || true
rm -rf ./@cli-dang/json/lib -rf ./@cli-dang/json/index.js || true
rm -rf ./@cli-dang/object/lib -rf ./@cli-dang/object/index.js || true
rm -rf ./tests || true
rm -rf ./types || true
rm -rf ./coverage || true
